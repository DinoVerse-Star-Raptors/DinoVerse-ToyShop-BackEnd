...
//       // Check if a tag with the same tagNumber already exists
//       const existingTag = await Tag.findOne({ tagNumber: tagData.tagNumber });

//       if (!existingTag) {
//         // If not, create a new tag
//         const tag = new Tag(tagData);
//         await tag.save();
//         console.log(`Tag "${tagData.name}" inserted successfully`);
//       } else {
//         console.log(`Tag with tagNumber ${tagData.tagNumber} already exists`);
//       }
//     }
//   } catch (error) {
//     console.error('Error inserting tags:', error);
//   } finally {
//     mongoose.connection.close(); // Close the database connection after insert
//   }
// };
